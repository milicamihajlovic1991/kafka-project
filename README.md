This project is POV for using Kafka. Datagenerator is a package that contains data module and function get_user_data that is used to generate fake users data. 
